...
const EventDetails = () => {
  ...
  // Determine the registration fee based on the event type
  let registrationFee = "";
  ...
  return (
    <div className="p-4 md:p-10 mt-24 text-white min-h-screen">
      <div className="max-w-4xl mx-auto text-white p-4 md:p-6">
        ...
        {/* Register Now Button */}
        <motion.button
          className="mb-8 w-60 md:w-auto md:ml-72 px-6 py-3 bg-sky-600 clip bg-opacity-70 border-2 border-sky-900 hover:bg-sky-800 transition-all text-white font-semibold text-xl md:text-2xl shadow-xl"
