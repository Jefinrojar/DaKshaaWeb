...
const Navbar = () => {
  ...
  return (
    <>
      <div className="fixed top-0 w-screen backdrop-blur-lg md:backdrop-blur-none z-50">
            ...
            <div className="md:col-span-6 col-span-12 mt-4">
              ...
              <ul className={`${isMenuOpen ? "block" : "hidden"} font-poppins md:flex mt-2 text-white justify-center items-center gap-8`}>
                ...
                >
                  ...
                  {isDropdownOpen && (
                    <ul className="absolute left-0 mt-52 bg-sky-900 border border-sky-800 clip-bottom-right text-sm shadow-lg w-44 text-center z-50">
                      <li
                      ...
                      <li
                        className="px-4 py-2 hover:bg-sky-700"
                        onClick={() => handleLinkClick("Hackathon", "/event/hackathon")}
                      >
                        Hackathon
                      </li>
                      <li
