...
function About() {
  return (
    <>
      ...
      <div className="mt-16 sm:mt-32 md:mt-56">
        <p
          ...
          >
            ...
            <div className="h-auto bg-sky-900 bg-opacity-50 p-3 sm:p-6 md:p-8 relative">
              ...
              <p className="text-sky-400 font-poppins leading-5 sm:leading-7 mt-10 sm:mt-14 md:mt-16 text-justify text-xs sm:text-base md:text-lg">
                ...
                Located near Tiruchengode, Tamil Nadu, it offers quality technical 
                education with 14 U.G., 11 P.G. and 12 Ph.D. programs. Approved by 
                AICTE and affiliated with Anna University, Chennai, KSRCT has 
                Autonomous status from UGC. It ranked 99th in NIRF 2017 and 51-100 
                band in NIRF Innovation Ranking 2023 for Engineering. Accredited 
                with NAAC A++ grade and NBA Tier 1 departments, it features modern 
                infrastructure including AICTE-IDEA Lab, ATAL Community Innovation 
                Centre, and MSME incubation centre. With NTTM funding of 6.5 crore 
                rupees, it fosters cutting-edge research and collaborates with 
                DST, DBT, DAE, CSIR, DRDO, and ISRO.
              </p>
            </div>
          </div>
        </div>
          ...
          >
            ...
            <div className="h-auto bg-sky-900 bg-opacity-50 p-3 sm:p-6 md:p-8 relative">
              ...
              <p className="text-sky-400 font-poppins leading-5 sm:leading-7 mt-10 sm:mt-14 md:mt-16 text-justify text-xs sm:text-base md:text-lg pb-4 sm:pb-8 md:pb-10">
                ...
                deleniti sint eligendi? Enim quo rerum beatae nemo unde saepe eos
                inventore nisi excepturi?
              </p>
            </div>
          </div>
        </div>
