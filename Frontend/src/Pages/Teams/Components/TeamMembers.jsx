...
const categories = ["All", "Developers", "Web-Designers", "Co-ordinators"];
...
const Teams = () => {
  ...
  const containerVariants = {
    ...
    visible: {
      ...
      transition: {
        ...
        delayChildren: 0.1, // Initial delay before the first child animation
      },
    },
  };
  ...
  return (
    <div className="w-full p-6">
          ...
          <button
            ...
            className={`p-1 font-semibold text-sky-400 ${
              selectedCategory === category
                ? "bg-sky-900/60"
                : "bg-transparent border border-sky-800 hover:bg-sky-900/60"
            }`}
          >
      ...
      {/* Team Members Grid */}
      <motion.div
        className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 place-items-center gap-10 mt-16"
      ...
      >
        {filteredMembers.map((member) => (
          ...
          >
            ...
            />
            {/* Name */}
            <h3 className="text-sky-500 text-lg font-semibold mt-4">
              {member.name}
            </h3>
            {/* Department */}
